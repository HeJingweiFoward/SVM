package distributedSVM.bagging;
...
import distributedSVM.bagging.io.TrainingSubsetInputFormat;
...
//				FSDataOutputStream fos = fs.create(file);
	...
	public static void main(String[] args) throws Exception {
        ...
        Path path2 =  new Path(args[1] + "/base-model-subsets");
        Path path3 =  new Path(args[1] + "/base-model-SVs");
		...
		prepartitionJobs[1] = Job.getInstance(prepartitionConfs[1], "Cascade SVM: Partitioning training data, Phase 1");
		...
		Job baggingJob = Job.getInstance(baggingJobConf,"Bagging SVM: Base models training");
